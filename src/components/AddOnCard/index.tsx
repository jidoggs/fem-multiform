...
function AddOnCard({ sub, title, type }: Props) {
  ...
  return (
    <div
      className={clsx(
        "flex pt-3.5 pb-2.5 px-4 border rounded-lg items-center gap-x-[18px] lg:gap-x-6",
        isChecked
    ...
    >
      ...
      <div className="flex-1 flex items-center justify-between">
        <div className="flex flex-col gap-y-1.5 font-medium">
          <h4 className="text-themeNavyBlue text-sm leading-none lg:text-base">
            {title}
          </h4>
          <p className="text-themeGray-10 text-xs leading-none lg:text-sm">
            {sub}
          </p>
        </div>
